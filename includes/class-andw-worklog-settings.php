...
class ANDW_Worklog_Settings {
    ...
    public function register_master_settings() {
        register_setting('andw_settings', 'andw_requesters', [
            'type' => 'array',
        ...
        register_setting('andw_settings', 'andw_workers', [
            'type' => 'array',
            'sanitize_callback' => [$this, 'sanitize_list'],
        ...
        <div class="wrap">
            ...
            jQuery(document).ready(function($) {
                ...
                $('#ofwn-clear-cache-btn').on('click', function() {
                    ...
                    $.post(ajaxurl, {
                        action: 'andw_clear_cache',
                        nonce: '<?php echo esc_attr(wp_create_nonce('andw_clear_cache')); ?>'
                    }, function(response) {
                        if (response.success) {
